 ...
 * Statement upload.
 *
 * The alternative was scp-ing a file onto the server every month, which is the
 * kind of friction that means the import quietly stops happening — and a
 * missing statement understates spending rather than failing, because the
 * payment settling those purchases is excluded either way.
 */
